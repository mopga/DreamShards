...
const NAME_REGEX = /^[A-Za-zÀ-ßà-ÿ¨¸\s'\-]{2,16}$/;
...
export function HeroNameModal() {
  ...
  return (
    <div className="relative z-10 flex w-full items-center justify-center">
      ...
      <div className="relative max-w-lg rounded-3xl border border-indigo-400/30 bg-slate-900/90 p-8 text-slate-100 shadow-[0_0_40px_rgba(90,126,255,0.25)]">
